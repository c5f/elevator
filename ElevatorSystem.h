/**
 * Author: Colin Scott-Fleming
 * Created: 2012-11-09
 * DEVELOPER CODING EXERCISE: Model an Elevator System
 *
 * Features:
 *
...
@interface ElevatorSystem : NSObject

@property NSMutableArray *elevators;
@property int totalServiceRequests;
